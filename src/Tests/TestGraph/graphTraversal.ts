...
import {depthFirstTraversal, breadthFirstTraversal} from "../../Algorithms/GraphTraversal/graphTraversal";


const simpleGraph = new Graph(false, true);
...
depthFirstTraversal(simpleGraph.vertices[0], (vertex) => {console.log(vertex.data)});

console.log("\n== Breadth First Graph Traversal: \n")
breadthFirstTraversal(simpleGraph.vertices[0], (vertex) => {console.log(vertex.data)});
