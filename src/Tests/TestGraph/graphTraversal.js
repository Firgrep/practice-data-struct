...
const graphTraversal_1 = require("../../Algorithms/GraphTraversal/graphTraversal");
const simpleGraph = new Graph_1.default(false, true);
...
(0, graphTraversal_1.depthFirstTraversal)(simpleGraph.vertices[0], (vertex) => { console.log(vertex.data); });
console.log("\n== Breadth First Graph Traversal: \n");
(0, graphTraversal_1.breadthFirstTraversal)(simpleGraph.vertices[0], (vertex) => { console.log(vertex.data); });
