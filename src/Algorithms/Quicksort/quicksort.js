 ...
 */
const quicksort = (array, log = false, leftBound = 0, rightBound = array.length - 1) => {
...
const partition = (array, leftIndex, rightIndex, log) => {
    ...
    while (leftIndex <= rightIndex) {
        ...
        if (leftIndex <= rightIndex) {
            ...
            (0, swap_1.default)(array, leftIndex, rightIndex);
